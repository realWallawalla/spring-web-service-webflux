...
class MashUpRestHandlerTest {
  ...
  private final String mbId = "f90e8b26-9e52-4669-a5c9-e28529c47894";
    ...
    @Mock
    private MashUpOutputConverter mashUpOutputConverter;

    private MashUpRestHandler mashUpRestHandler;

    @BeforeEach
  void setUp() {
        mashUpRestHandler = new MashUpRestHandler(mashUpService, throttlingService, mashUpOutputConverter);
    }

    @Test
  void getMashUp_should_return_mashupMessage_according_to_contract() {
        MashUp mashUp1 = new MashUp();
        mashUp1.setMbId(mbId);
